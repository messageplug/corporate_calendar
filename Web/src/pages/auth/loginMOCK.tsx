      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Войдите в систему управления календарями
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-sm text-gray-600 mb-3">
              Для тестирования используйте (пароль: password123):
            </p>
            <div className="space-y-2">
              ...
              >
                <span className="font-medium">Администратор:</span> admin@example.com
              </button>
              <button
                type="button"
                ...
                className="w-full text-left px-3 py-2 text-sm bg-gray-50 hover:bg-gray-100 rounded-lg text-gray-700 transition-colors"
              >
                <span className="font-medium">Менеджер:</span> manager@example.com
              </button>
              <button
                type="button"
                ...
                className="w-full text-left px-3 py-2 text-sm bg-gray-50 hover:bg-gray-100 rounded-lg text-gray-700 transition-colors"
              >
                <span className="font-medium">Пользователь:</span> user@example.com
              </button>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-400">
            © 2026 CRM Календарь. Все права защищены.
          </p>
        </div>
      </div>
    </div>
